...
VALUES
  ('90000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'RacetrackCreated', '{"entity_type":"Racetrack","twin_id":"twin:racetrack:demo-park","dtdl_model_id":"dtmi:trackmind:Racetrack;3","state":{"name":"Demo Park","timezone":"America/New_York","commission_name":"Demo Racing Commission","geojson":{"type":"Feature","properties":{"track":"Demo Park"}}}}'::jsonb, '2026-06-14T00:01:00Z', 'seed-service', 'racing-officials', 'seed-loader', 'chief-steward', '2026-06-14T00:01:00Z'),
  ('90000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000001', 'PersonCreated', '{"entity_type":"Person","twin_id":"twin:person:casey-trainer","dtdl_model_id":"dtmi:trackmind:Person;3","state":{"display_name":"Casey Trainer","roles":["trainer"],"license_number":"T-100","organization":"Demo Stable","credential_status":"active"}}'::jsonb, '2026-06-14T00:02:00Z', 'seed-service', 'racing-officials', 'seed-loader', 'chief-steward', '2026-06-14T00:02:00Z'),
  ('90000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000002', 'PersonCreated', '{"entity_type":"Person","twin_id":"twin:person:alex-rider","dtdl_model_id":"dtmi:trackmind:Person;3","state":{"display_name":"Alex Rider","roles":["jockey"],"license_number":"J-100","organization":"Demo Jockey Guild","credential_status":"active"}}'::jsonb, '2026-06-14T00:03:00Z', 'seed-service', 'racing-officials', 'seed-loader', 'chief-steward', '2026-06-14T00:03:00Z'),
  ('90000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000003', 'PersonCreated', '{"entity_type":"Person","twin_id":"twin:person:jordan-steward","dtdl_model_id":"dtmi:trackmind:Person;3","state":{"display_name":"Jordan Steward","roles":["official"],"license_number":"S-100","organization":"Demo Racing Commission","credential_status":"active"}}'::jsonb, '2026-06-14T00:04:00Z', 'seed-service', 'racing-officials', 'seed-loader', 'chief-steward', '2026-06-14T00:04:00Z'),
  ('90000000-0000-0000-0000-000000000005', '30000000-0000-0000-0000-000000000001', 'HorseCreated', '{"entity_type":"Horse","twin_id":"twin:horse:safety-first","dtdl_model_id":"dtmi:trackmind:Horse;3","state":{"registered_name":"Safety First","microchip_id":"985141000000001","foaled":"2021-04-01","welfare_status":"active","trainer_twin_id":"twin:person:casey-trainer"}}'::jsonb, '2026-06-14T00:05:00Z', 'seed-service', 'racing-officials', 'seed-loader', 'chief-steward', '2026-06-14T00:05:00Z'),
  ('90000000-0000-0000-0000-000000000006', '40000000-0000-0000-0000-000000000001', 'RaceCreated', '{"entity_type":"Race","twin_id":"twin:race:demo-park:2026-06-14:1","dtdl_model_id":"dtmi:trackmind:Race;3","state":{"racetrack_twin_id":"twin:racetrack:demo-park","race_number":1,"race_date":"2026-06-14","status":"scheduled","distance_meters":1600}}'::jsonb, '2026-06-14T00:06:00Z', 'seed-service', 'racing-officials', 'seed-loader', 'chief-steward', '2026-06-14T00:06:00Z'),
  ('90000000-0000-0000-0000-000000000007', '50000000-0000-0000-0000-000000000001', 'RestrictedZoneCreated', '{"entity_type":"RestrictedZone","twin_id":"twin:zone:demo-park:paddock","dtdl_model_id":"dtmi:trackmind:RestrictedZone;3","state":{"racetrack_twin_id":"twin:racetrack:demo-park","zone_code":"PADDOCK","name":"Paddock Restricted Zone","boundary_geojson":{"type":"Polygon","coordinates":[]},"access_policy":{"roles":["official","trainer"],"approvalRequiredForOverride":true},"active":true}}'::jsonb, '2026-06-14T00:07:00Z', 'seed-service', 'racing-officials', 'seed-loader', 'chief-steward', '2026-06-14T00:07:00Z'),
  ('90000000-0000-0000-0000-000000000008', '60000000-0000-0000-0000-000000000001', 'SensorCreated', '{"entity_type":"Sensor","twin_id":"twin:sensor:surface-1","dtdl_model_id":"dtmi:trackmind:Sensor;3","state":{"racetrack_twin_id":"twin:racetrack:demo-park","sensor_code":"surface-1","sensor_type":"surface-moisture","location":{"sector":"far-turn"},"status":"online","restricted_zone_twin_id":"twin:zone:demo-park:paddock"}}'::jsonb, '2026-06-14T00:08:00Z', 'seed-service', 'racing-officials', 'seed-loader', 'chief-steward', '2026-06-14T00:08:00Z'),
  ('90000000-0000-0000-0000-000000000009', '70000000-0000-0000-0000-000000000001', 'CameraCreated', '{"entity_type":"Camera","twin_id":"twin:camera:paddock-1","dtdl_model_id":"dtmi:trackmind:Camera;3","state":{"racetrack_twin_id":"twin:racetrack:demo-park","camera_code":"paddock-1","stream_uri":"rtsp://example.invalid/paddock-1","field_of_view":{"sector":"paddock"},"status":"online","restricted_zone_twin_id":"twin:zone:demo-park:paddock"}}'::jsonb, '2026-06-14T00:09:00Z', 'seed-service', 'racing-officials', 'seed-loader', 'chief-steward', '2026-06-14T00:09:00Z'),
  ('90000000-0000-0000-0000-000000000010', '80000000-0000-0000-0000-000000000001', 'IncidentCreated', '{"entity_type":"Incident","twin_id":"twin:incident:paddock-access-1","dtdl_model_id":"dtmi:trackmind:Incident;3","state":{"racetrack_twin_id":"twin:racetrack:demo-park","race_twin_id":"twin:race:demo-park:2026-06-14:1","restricted_zone_twin_id":"twin:zone:demo-park:paddock","severity":"warning","status":"open","occurred_at":"2026-06-14T00:10:00Z","summary":"Unapproved paddock access attempt detected.","evidence_links":["eventhub://trackmind-events/paddock-access-1","camera://paddock-1/clip-001"]}}'::jsonb, '2026-06-14T00:10:00Z', 'seed-service', 'stewards', 'seed-loader', 'chief-steward', '2026-06-14T00:10:00Z')
