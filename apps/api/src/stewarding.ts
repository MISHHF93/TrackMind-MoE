...
export function listStewardInquiries(): StewardInquiry[] {
  ...
  addStewardEvidence(inquiry, { id: 'ev-pan-angle', kind: 'video', uri: 's3://stewards/race-7/pan-angle.mp4', capturedAt: '2026-06-13T21:04:10.000Z', addedBy: 'video-review', description: 'Pan replay angle — stretch run-in', hash: 'sha256:pan-angle', sourceSystem: 'video-evidence', twinContextIds: ['twin:race-7', 'twin:horse-4'], content: { camera: 'pan', raceId: 'race-7' } }, deps);
