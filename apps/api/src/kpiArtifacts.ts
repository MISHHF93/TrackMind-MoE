...
const seeds: KPIDefinitionSeed[] = [
  ...
  seed('paddock-operations', 'Paddock parade readiness', 'Percentage of assigned horses parade-ready with inspections and readiness checks complete.', 'percentage', 88, '%', 95, 'watch', 'insufficient-history', 'racing-secretary', 'approval-visible', 'race:request-start', ['paddock-operations.readiness.recorded', 'paddock-operations.assignment.recorded'], [{ entityType: 'paddock-operations', entityId: 'main-track' }]),
