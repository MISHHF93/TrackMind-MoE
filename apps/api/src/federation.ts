  ...
  return {
    ...
    industryAnalytics: {
      ...
      products: [
        ...
        { analyticId: 'certification-readiness-industry-summary', label: 'Certification readiness industry summary', schemaVersion: 'trackmind.federation.analytics.v1', aggregationLevel: 'certification-tier', anonymized: true, cohortSize: 18, minCohortSize: 10, policyId: 'federation-data-sharing-v1', permittedUse: ['certification program capacity planning'], prohibitedUse: ['operator ranking without consent', 'raw control evidence review'], dimensions: ['readinessStatus'], measures: [{ name: 'candidateTracks', value: 12, unit: 'count', aggregation: 'count' }], rawRecordRefs: [] },
      ],
    },
    rawDataExposure: {
      exposed: false,
