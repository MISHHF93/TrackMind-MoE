import { normalizeApprovalStatus, normalizeProtectedActionIntent, normalizeRole, type ApprovalStatus, type ApprovalViewStatusDto, type ApprovalWorkflowStatus, type CanonicalApprovalRequest, type CanonicalApprovalStep, type ProtectedAction, type Role } from '@trackmind/shared';
...
function canonicalizeRoles(roles: Iterable<string>): Role[] {
  return [...roles].map((role) => normalizeRole(role)).filter((role): role is Role => role !== undefined);
}
...
export function defaultApprovalPolicies(): ApprovalPolicy[] {
  ...
  return [
    { action: 'race-start', chain: [{ id: 'race-office', roles: ['horse-operations-coordinator'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'veterinary', roles: ['veterinarian'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 15, escalationRules: [{ afterMinutes: 10, escalateToRoles: ['platform-super-admin'], reason: 'race start approval SLA exceeded' }] },
    { action: 'race-cancellation', chain: [{ id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 30, escalationRules: [{ afterMinutes: 15, escalateToRoles: ['platform-super-admin'], reason: 'cancellation approval SLA exceeded' }] },
    { action: 'race-stop', chain: [{ id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'emergency-command', roles: ['security-manager'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 5, escalationRules: [{ afterMinutes: 2, escalateToRoles: ['platform-super-admin'], reason: 'race stop approval SLA exceeded' }] },
    ...
    { action: 'veterinary-clearance', chain: [{ id: 'veterinary', roles: ['veterinarian'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 30, escalationRules: [{ afterMinutes: 15, escalateToRoles: ['platform-super-admin'], reason: 'vet clearance pending' }] },
    ...
    { action: 'clear-vet-flag', chain: [{ id: 'veterinary', roles: ['veterinarian'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 30, escalationRules: [{ afterMinutes: 15, escalateToRoles: ['platform-super-admin'], reason: 'vet flag clearance pending' }] },
    ...
    { action: 'payout', chain: [{ id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'finance-manager', roles: ['finance-manager'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 20, escalationRules: [{ afterMinutes: 10, escalateToRoles: ['platform-super-admin'], reason: 'payout approval pending' }] },
    { action: 'emergency-action', chain: [{ id: 'security-manager', roles: ['security-manager'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 5, escalationRules: [{ afterMinutes: 2, escalateToRoles: ['platform-super-admin'], reason: 'emergency action approval pending' }] },
    { action: 'official-results', chain: [{ id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'finance-manager', roles: ['finance-manager'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 20, escalationRules: [{ afterMinutes: 10, escalateToRoles: ['platform-super-admin'], reason: 'official results approval pending' }] },
    { action: 'modify-official-results', chain: [{ id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'finance-manager', roles: ['finance-manager'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'compliance', roles: ['compliance-officer'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 20, escalationRules: [{ afterMinutes: 10, escalateToRoles: ['platform-super-admin'], reason: 'official results modification approval pending' }] },
    { action: 'starting-gate-move', chain: [{ id: 'race-office', roles: ['horse-operations-coordinator'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'operations', roles: ['facilities-manager'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 15, escalationRules: [{ afterMinutes: 8, escalateToRoles: ['platform-super-admin'], reason: 'starting gate move approval pending' }] },
    { action: 'race-office-scratch', chain: [{ id: 'veterinary', roles: ['veterinarian'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 30, escalationRules: [{ afterMinutes: 15, escalateToRoles: ['platform-super-admin'], reason: 'race scratch approval pending' }] },
    { action: 'scratch-horse', chain: [{ id: 'veterinary', roles: ['veterinarian'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 30, escalationRules: [{ afterMinutes: 15, escalateToRoles: ['platform-super-admin'], reason: 'horse scratch approval pending' }] },
    { action: 'race-status-change', chain: [{ id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 20, escalationRules: [{ afterMinutes: 10, escalateToRoles: ['platform-super-admin'], reason: 'race status change approval pending' }] },
    { action: 'race-office-configuration', chain: [{ id: 'race-office', roles: ['horse-operations-coordinator'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'operations', roles: ['facilities-manager'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 60, escalationRules: [{ afterMinutes: 30, escalateToRoles: ['platform-super-admin'], reason: 'race office configuration approval pending' }] },
    { action: 'facility-maintenance-execution', chain: [{ id: 'facilities', roles: ['facilities-manager'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'operations-command', roles: ['platform-super-admin'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 45, escalationRules: [{ afterMinutes: 20, escalateToRoles: ['platform-super-admin'], reason: 'facility maintenance execution approval pending' }] },
    { action: 'emergency-personnel-override', chain: [{ id: 'security-manager', roles: ['security-manager'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'emergency-command', roles: ['platform-super-admin'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 5, escalationRules: [{ afterMinutes: 2, escalateToRoles: ['platform-super-admin'], reason: 'emergency personnel override approval pending' }] },
    { action: 'disciplinary-decision', chain: [{ id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'compliance', roles: ['compliance-officer'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 60, escalationRules: [{ afterMinutes: 30, escalateToRoles: ['platform-super-admin'], reason: 'disciplinary decision approval pending' }] },
    { action: 'safety-critical-control', chain: [{ id: 'operations', roles: ['facilities-manager'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 20, escalationRules: [{ afterMinutes: 10, escalateToRoles: ['platform-super-admin'], reason: 'safety-critical barn control approval pending' }] },
    { action: 'race-distance-configuration', chain: [{ id: 'race-office', roles: ['horse-operations-coordinator'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'operations', roles: ['facilities-manager'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 20, escalationRules: [{ afterMinutes: 10, escalateToRoles: ['platform-super-admin'], reason: 'race distance configuration approval pending' }] },
    { action: 'surface-irrigation', chain: [{ id: 'surface-operations', roles: ['facilities-manager'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 30, escalationRules: [{ afterMinutes: 15, escalateToRoles: ['platform-super-admin'], reason: 'surface irrigation approval pending' }] },
    { action: 'surface-harrowing', chain: [{ id: 'surface-operations', roles: ['facilities-manager'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 30, escalationRules: [{ afterMinutes: 15, escalateToRoles: ['platform-super-admin'], reason: 'surface harrowing approval pending' }] },
    { action: 'surface-rolling', chain: [{ id: 'surface-operations', roles: ['facilities-manager'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 30, escalationRules: [{ afterMinutes: 15, escalateToRoles: ['platform-super-admin'], reason: 'surface rolling approval pending' }] },
    { action: 'surface-track-closure-recommendation', chain: [{ id: 'surface-operations', roles: ['facilities-manager'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 15, escalationRules: [{ afterMinutes: 8, escalateToRoles: ['platform-super-admin'], reason: 'surface closure recommendation approval pending' }] },
    { action: 'track-closure', chain: [{ id: 'surface-operations', roles: ['facilities-manager'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'security-manager', roles: ['security-manager'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 10, escalationRules: [{ afterMinutes: 5, escalateToRoles: ['platform-super-admin'], reason: 'track closure approval pending' }] },
    { action: 'track-reopen', chain: [{ id: 'surface-operations', roles: ['facilities-manager'], minimumApprovals: 1, evidenceRequired: evidence }, { id: 'stewards', roles: ['steward'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 15, escalationRules: [{ afterMinutes: 8, escalateToRoles: ['platform-super-admin'], reason: 'track reopen approval pending' }] },
    { action: 'compliance-filing-approval', chain: [{ id: 'compliance', roles: ['compliance-officer'], minimumApprovals: 1, evidenceRequired: ['human-approval-record','reason','audit-readiness-package'] }], expiresInMinutes: 240, escalationRules: [{ afterMinutes: 120, escalateToRoles: ['platform-super-admin'], reason: 'compliance filing approval pending' }] },
    { action: 'kpi-threshold-change', chain: [{ id: 'kpi-admin', roles: ['platform-super-admin', 'organization-admin'], minimumApprovals: 1, evidenceRequired: evidence }], expiresInMinutes: 60, escalationRules: [{ afterMinutes: 30, escalateToRoles: ['compliance-officer'], reason: 'KPI threshold change approval pending' }] },
  ];
}
...
export class CentralizedApprovalService {
  ...
  decide(requestId: string, actor: ApprovalActor, decision: 'approved'|'rejected', reason: string, evidence: string[], now = new Date().toISOString()): ControlledActionRequest {
    ...
    const delegatedFor = this.delegatedPrincipal(actor.id, openStep.roles, now); const effectiveRoles = [...new Set(canonicalizeRoles([...actor.roles, ...(delegatedFor?.roles ?? [])]))];
    const allowedRoles = [...new Set(canonicalizeRoles([...openStep.roles, ...(request.status === 'escalated' ? request.escalatedToRoles : [])]))];
  ...
  private delegatedPrincipal(actorId: string, roles: Role[], now: string): { principalId: string; roles: Role[] } | undefined { const allowed = canonicalizeRoles(roles); for (const [principalId, entries] of this.delegations) { const hit = entries.find((entry) => entry.delegateId === actorId && !entry.revokedAt && entry.expiresAt > now && canonicalizeRoles(entry.roles).some((role) => allowed.includes(role))); if (hit) return { principalId, roles: canonicalizeRoles(hit.roles) }; } return undefined; }
