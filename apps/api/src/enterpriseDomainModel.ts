...
export const enterpriseDomainSchemas: readonly DomainSchemaDefinition[] = [
  ...
  schema('security-personnel', 'Security Personnel', 'Security Operations', [{ name: 'badgeId', type: 'string', required: true, description: 'Badge identifier.' }], ['security'], 'confidential'),
  ...
  schema('incident', 'Incident', 'Operations Center', [{ name: 'severity', type: 'string', required: true, description: 'Incident severity.' }], ['safety', 'security'], 'regulated'),
