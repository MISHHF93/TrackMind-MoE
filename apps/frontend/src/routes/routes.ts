...
export const routes = [
  ...
  },
  {
    ...
    requiredRoles: 'authenticated',
    supportStatus: 'facade-api',
    dataSource: 'Review emergency posture, incident metadata, security incident summaries, and response references without exposing direct control actions.',
  ...
  },
  {
    ...
    supportStatus: 'facade-api',
    dataSource: 'Review compliance frameworks, control mappings, and certification-readiness metadata from the control-library facade.',
  ...
  },
  {
    ...
    supportStatus: 'facade-api',
    dataSource: 'Review security incident, investigation, restricted-zone, access-event, and camera-health metadata from a facade-backed DTO.',
    ...
    limitations: ['Sensitive DTO fields are masked by the backend unless privileged security access or approved sensitive access is present. Frontend is read-only; no incident escalation, investigation mutation/export, camera control, camera-health update, or emergency-zone action is exposed.'],
  },
  {
    id: 'facilities',
    path: '/facilities',
  ...
  },
  {
    ...
    supportStatus: 'facade-api',
    dataSource: 'Review active ticket value, protected payout workflow metadata, finance controls, and approval/audit boundaries.',
  ...
  },
  {
    ...
    supportStatus: 'facade-api',
    dataSource: 'Inspect provider license-readiness metadata, lineage, quality, entity resolution, and export-control posture.',
    ...
    limitations: ['Provider license-readiness metadata only; no external license, scraping, or live provider claim.'],
  },
  {
    id: 'audit',
    path: '/audit',
