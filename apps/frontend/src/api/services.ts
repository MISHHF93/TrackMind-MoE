    ...
    return vm('facilities', facilities.source, {
      ...
      approvals: [
        ...
        ...data.approvals.map((approval) => localApprovalDto({
          ...
          evidence: approval.evidence,
          workflowId: (approval as { workflowInstanceId?: string }).workflowInstanceId ?? approval.workflowId,
          requiredRoles: approval.requiredRoles ?? approval.approverRoles ?? ['track-superintendent', 'admin'],
