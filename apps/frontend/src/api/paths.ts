...
export const apiPaths = {
  ...
  analytics: { workspace: '/analytics/workspace', knowledgeGraph: '/knowledge-graph/workspace', knowledgeGraphSearch: '/knowledge-graph/search' },
...
export const routeApiPathGroups = {
  ...
  equine: [apiPaths.equine.horse, apiPaths.equine.barnOperations, apiPaths.equine.horseProfile, apiPaths.equine.eligibility, apiPaths.equine.equineWelfare, apiPaths.equine.equineWelfareDashboard, apiPaths.equine.equineWelfareAuditTrail, ...commonContextApiPaths],
  ...
  analytics: [apiPaths.analytics.workspace, apiPaths.analytics.knowledgeGraph, apiPaths.analytics.knowledgeGraphSearch, apiPaths.search.global, apiPaths.federation.kpiAggregation, ...commonContextApiPaths],
...
const pathSources: Record<string, ApiAdapterSource> = {
  ...
  [apiPaths.equine.startingGateOperations]: 'live-api',
