...
function routeSpecificActions(routeId: DomainRouteId, results: WorkspaceDataResult[]): WorkspaceAction[] {
  ...
  const byRoute: Record<DomainRouteId, WorkspaceAction[]> = {
    ...
    security: [
      { id: 'security-cctv-viewer', label: 'CCTV viewer', detail: 'Open the in-house multi-camera media viewer.', href: '/cctv-viewer' },
    ...
    admin: [
      ...
      { id: 'admin-cctv-registry', label: 'CCTV device registry', detail: 'Manage canonical camera fleet metadata with audit-aware edits.', href: '/cctv-registry' },
      { id: 'admin-cctv-viewer', label: 'CCTV viewer', detail: 'Open the in-house multi-camera media viewer.', href: '/cctv-viewer' },
      { id: 'admin-iot-registry', label: 'IoT device registry', detail: 'Manage non-camera sensors and telemetry devices.', href: '/iot-registry' },
      { id: 'admin-zone-mapping', label: 'Zone & facility mapping', detail: 'Map cameras and IoT devices to operational zones.', href: '/surveillance-zone-mapping' },
    ...
    iotMonitoring: [
      { id: 'iot-vendor-contracts', label: 'Vendor integration contracts', detail: 'Review provider-ready CCTV and IoT adapter contracts.', href: '/iot-monitoring#surveillance-vendor-integration' },
      { id: 'iot-cctv-viewer', label: 'CCTV viewer', detail: 'Open the in-house multi-camera media viewer.', href: '/cctv-viewer' },
      { id: 'iot-registry', label: 'CCTV device registry', detail: 'Open the canonical camera registry.', href: '/cctv-registry' },
      { id: 'iot-iot-registry', label: 'IoT device registry', detail: 'Open the non-camera sensor and telemetry registry.', href: '/iot-registry' },
      { id: 'iot-zone-mapping', label: 'Zone & facility mapping', detail: 'Map devices to operational racetrack zones.', href: '/surveillance-zone-mapping' },
      { id: 'iot-health', label: 'Surveillance health', detail: 'Open control-plane health monitoring.', href: '/surveillance-health' },
    ...
    cctvRegistry: [
      { id: 'cctv-viewer', label: 'CCTV viewer', detail: 'Open the in-house multi-camera media viewer.', href: '/cctv-viewer' },
      { id: 'cctv-monitoring', label: 'IoT monitoring', detail: 'Return to integration and SOC monitoring workspace.', href: '/iot-monitoring' },
      { id: 'cctv-iot-registry', label: 'IoT device registry', detail: 'Open non-camera sensor and telemetry registry.', href: '/iot-registry' },
      { id: 'cctv-zone-mapping', label: 'Zone mapping', detail: 'Open operational zone and facility mapping.', href: '/surveillance-zone-mapping' },
      { id: 'cctv-health', label: 'Surveillance health', detail: 'Open control-plane health monitoring.', href: '/surveillance-health' },
      { id: 'cctv-governance', label: 'Governance audit trail', detail: 'Review surveillance IoT governance workspace.', href: '/cctv-registry?focus=governance' },
    ],
    cctvViewer: [
      { id: 'viewer-registry', label: 'CCTV registry', detail: 'Open the canonical camera fleet registry.', href: '/cctv-registry' },
      { id: 'viewer-monitoring', label: 'IoT monitoring', detail: 'Return to integration and SOC monitoring workspace.', href: '/iot-monitoring' },
      { id: 'viewer-health', label: 'Surveillance health', detail: 'Open control-plane health monitoring.', href: '/surveillance-health' },
    ],
    cctvCameraDetail: [
      { id: 'camera-detail-viewer', label: 'Open in viewer', detail: 'Focus this camera in the in-house CCTV viewer.', href: '/cctv-viewer' },
      { id: 'camera-detail-registry', label: 'CCTV registry', detail: 'Return to the camera fleet registry.', href: '/cctv-registry' },
      { id: 'camera-detail-zones', label: 'Zone mapping', detail: 'Open operational zone and facility mapping.', href: '/surveillance-zone-mapping' },
      { id: 'camera-detail-health', label: 'Surveillance health', detail: 'Open control-plane health monitoring.', href: '/surveillance-health' },
    ],
    iotRegistry: [
      { id: 'iot-cctv-registry', label: 'CCTV device registry', detail: 'Open the canonical camera registry.', href: '/cctv-registry' },
      { id: 'iot-zone-mapping', label: 'Zone mapping', detail: 'Open operational zone and facility mapping.', href: '/surveillance-zone-mapping' },
      { id: 'iot-health', label: 'Surveillance health', detail: 'Open control-plane health monitoring.', href: '/surveillance-health' },
      { id: 'iot-monitoring', label: 'IoT monitoring', detail: 'Return to integration and SOC monitoring workspace.', href: '/iot-monitoring' },
      { id: 'iot-governance', label: 'Governance audit trail', detail: 'Review surveillance IoT governance workspace.', href: '/iot-registry?focus=governance' },
    ],
    iotDeviceDetail: [
      { id: 'device-detail-registry', label: 'IoT registry', detail: 'Return to the IoT device fleet registry.', href: '/iot-registry' },
      { id: 'device-detail-zones', label: 'Zone mapping', detail: 'Open operational zone and facility mapping.', href: '/surveillance-zone-mapping' },
      { id: 'device-detail-health', label: 'Surveillance health', detail: 'Open control-plane health monitoring.', href: '/surveillance-health' },
    ],
    surveillanceZoneMapping: [
      { id: 'zone-cctv', label: 'CCTV registry', detail: 'Open camera device registry.', href: '/cctv-registry' },
      { id: 'zone-iot', label: 'IoT registry', detail: 'Open IoT device registry.', href: '/iot-registry' },
      { id: 'zone-monitoring', label: 'IoT monitoring', detail: 'Open integration monitoring workspace.', href: '/iot-monitoring' },
      { id: 'zone-health', label: 'Surveillance health', detail: 'Open control-plane health monitoring.', href: '/surveillance-health' },
    ],
    surveillanceHealth: [
      { id: 'health-monitoring', label: 'IoT monitoring', detail: 'Return to integration and SOC monitoring workspace.', href: '/iot-monitoring' },
      { id: 'health-cctv', label: 'CCTV registry', detail: 'Open camera device registry.', href: '/cctv-registry' },
      { id: 'health-iot', label: 'IoT registry', detail: 'Open IoT device registry.', href: '/iot-registry' },
      { id: 'health-zones', label: 'Zone mapping', detail: 'Open operational zone and facility mapping.', href: '/surveillance-zone-mapping' },
      { id: 'health-alerting', label: 'Surveillance alerting', detail: 'Open canonical alert rules and events.', href: '/surveillance-alerting' },
    ],
    surveillanceAlerting: [
      { id: 'alerting-health', label: 'Surveillance health', detail: 'Open control-plane health monitoring.', href: '/surveillance-health' },
      { id: 'alerting-monitoring', label: 'IoT monitoring', detail: 'Return to integration and SOC monitoring workspace.', href: '/iot-monitoring' },
      { id: 'alerting-cctv', label: 'CCTV registry', detail: 'Open camera device registry.', href: '/cctv-registry' },
      { id: 'alerting-iot', label: 'IoT registry', detail: 'Open IoT device registry.', href: '/iot-registry' },
    ],
    analytics: [
