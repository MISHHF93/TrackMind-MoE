...
- Backend routes provide read-only access: `/api/v1/kpis`, `/api/v1/kpis/{kpiId}`, `/api/v1/kpis/{kpiId}/snapshots`, and `/api/v1/kpis/model-context`, plus equivalent read-only artifact aliases under `/api/v1/artifacts/kpis`.
