...
test('Universal Artifact contracts remain backward-compatible with existing AI, audit, and twin DTOs', () => {
  const aiRecommendation = {
    ...
    confidence: { raw: 0.86, calibrated: 0.82, band: 'medium', drivers: ['surface-telemetry', 'risk:high'] },
    confidenceValue: 0.82,
    evidence: ['surface:moisture=19','sensor-44:warning'],
    evidencePackage: {
      evidencePackageId: 'evidence-package:rec-harrow-7',
      evidence: [{ evidenceId: 'surface:moisture=19', kind: 'telemetry', source: 'surface' }],
      lineage: ['agent:agent-surface-ops', 'model:model-surface-advisor-v2'],
      hash: 'sha256:rec-harrow-7',
    },
    modelVersion: 'model-surface-advisor-v2',
    generatedAt: now,
    approvalRequirement: { required: true, policy: 'single-human', requiredApproverRoles: ['track-superintendent'], requirementId: 'approval-rec-harrow-7', workflowId: 'hitl-rec-harrow-7-1' },
    auditReference: { auditIds: ['audit-ai-1'], eventIds: ['ai.recommendation.created.v1'], digitalTwinRefs: ['twin:sector:far-turn'], approvalReference: 'approval-rec-harrow-7', correlationId: 'corr-ai-facade', integrityRef: 'evidence-package:rec-harrow-7' },
  ...
  const audit = {
    auditEventId: 'audit-ai-1',
    id: 'audit-ai-1',
    type: 'ai-recommendation',
    actor: { actorId: 'agent-surface-ops', actorType: 'ai-agent' },
    actorId: 'agent-surface-ops',
    entity: { entityId: 'rec-ai-1', entityType: 'ai-recommendation', tenantId: 'trackmind', racetrackId: 'main-track' },
    action: 'ai.recommendation.created',
    reason: 'AI recommendation recorded as advisory-only artifact evidence.',
    timestamp: now,
    tenantScope: { tenantId: 'trackmind', racetrackId: 'main-track' },
    integrityReference: { hash: 'sha256:ai-1', previousHash: 'genesis', algorithm: 'sha256', chainScope: 'tenant' },
    severity: 'warning',
    hash: 'sha256:ai-1',
