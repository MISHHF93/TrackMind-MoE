...
export const veterinaryPrivacyScopesByRole: Record<Role, VeterinaryPrivacyScope[]> = {
  admin: ['public', 'racing-officials', 'care-team', 'regulator', 'veterinary-confidential'],
  ...
  'track-superintendent': ['public', 'racing-officials', 'care-team'],
  security: ['public'],
  'ticketing-manager': ['public'],
  finance: ['public'],
  'operations-admin': ['public', 'racing-officials', 'care-team'],
